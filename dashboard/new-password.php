...
if (!isset($_SESSION["active"]) || !isset($_SESSION["username"]) || !$_SESSION["active"]) {
    ...
    if ($result->num_rows > 0) {
        ...
        if ($token != $row["token"] || $row["died_time_token"] < time()) {
            unset($_SESSION["active"]);
            unset($_SESSION["username"]);
            echo "hết thời gian hoặc khác token";
            $_SESSION["code"] = getCode(35);
            header("Location: login.php", true, 301);
            exit;
        }
    }
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="index.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user" id="inputPasswordRepeat" placeholder="Repeat password">
                                        </div>

                                        <button name="new-password" type="submit" class="btn btn-primary btn-user btn-block">Submit</button>
                                        <hr>
                                    </form>
                                </div>
                            </div>
